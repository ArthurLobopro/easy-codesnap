            ...
            <DetailsContent>
                <li>
                    ...
                    <select
                        ...
                        onChange={(ev) => {
                            set({
                                windowStyle: ev.currentTarget
                                    .value as WindowStyle,
                            });
                        }}
                    >
                ...
                <li>
                    ...
                    <select
                        ...
                        onChange={(ev) => {
                            set({
                                windowIconType: ev.currentTarget
                                    .value as WindowIconType,
                            });
                        }}
                    >
                        ...
                        <span className="tooltip-text">
                            <span>
                                {text(
                                    ...
                                    t(
                                        "You can edit the default Window Title text clicking",
                                    ),
                                )}
                            </span>
                            <span
                                className="link"
                                onClick={() =>
                                    openConfig("windowTitleTemplate")
                                }
                            >
                                {t("here")}
                            </span>
                    ...
                    <span className="tooltip-text">
                        <span>
                            {text(
                                ...
                                t(
                                    "Only valid when `Rounded Corners` is marked",
                                ),
                            )}
                        </span>
                    </span>
