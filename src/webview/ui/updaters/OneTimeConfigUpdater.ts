...
import { enableResizingInput, realLineNumbersInput, roundedCornersInput, roundingLevelSelect, saveFormatSelect, showLineNumbersInput, showWindowControlsInput, showWindowTitleInput, shutterActionSelect, targetSelect, transparentBackgroundInput, windowStyleSelect } from "../../elements"


export function OneTimeConfigUpdater() {
    const {
        showLineNumbers, realLineNumbers, showWindowControls, roundedCorners, transparentBackground, showWindowTitle, shutterAction, target, enableResizing, roundingLevel, saveFormat, windowStyle
    } = getSessionConfig()
